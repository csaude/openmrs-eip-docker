...
echo "EMAIL_CONTENT_FILE: $EMAIL_CONTENT_FILE"
echo "EMAIL_ATTACHMENT: $EMAIL_ATTACHMENT"
echo "CURR_NOTIFICATION_FOLDER: $CURR_NOTIFICATION_FOLDER"

mkdir -p $CURR_NOTIFICATION_FOLDER

mv $MAIL_RECIPIENTS $CURR_NOTIFICATION_FOLDER/MAIL_RECIPIENTS
mv $MAIL_SUBJECT $CURR_NOTIFICATION_FOLDER/MAIL_SUBJECT
