...
export RELEASE_DESC="DBSYnc v1.5x compatibility"

export OPENMRS_EIP_APP_RELEASE_URL="https://github.com/csaude/openmrs-eip-docker/releases/download/V7.0.0/openmrs-eip-app-1.4.0.jar"
export EPTS_ETL_API_RELEASE_URL="https://github.com/csaude/openmrs-eip-docker/releases/download/V7.0.0/eptssync-api-1.0.jar"
